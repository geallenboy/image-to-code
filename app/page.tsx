...
export default function Home() {
  ...
  return (
    <div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className='flex items-center gap-2'>
                ...
                <h2 className='font-bold text-lg'>ImageToCode</h2>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
          ...
          <div className="flex justify-center">
            <a className="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-sm text-gray-800 p-1 ps-3 rounded-full transition hover:border-gray-300 dark:bg-neutral-800 dark:border-neutral-700 dark:hover:border-neutral-600 dark:text-neutral-200"
              href="https://gegarron.com" target="_blank">
              gegarron.com
          ...
          <div className="mt-5 max-w-2xl text-center mx-auto">
            <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
             图片生成
              <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">Code</span>
            </h1>
          </div>
          ...
          <div className="mt-5 max-w-3xl text-center mx-auto">
            ...
            基于人工智能的应用程序彻底改变您的Code方式，提供设计图片在几秒钟生成高质量应用程序。</p>
          </div>
      ...
      <div>
        <Image src={'/Imagetocode.png'} alt="image" width={800} height={900}
